...
namespace NS_Backup
{
    ...
    ***************************************************************************/
    public class MainDlg : System.Windows.Forms.Form
	{
        ...
        ***************************************************************************/
        public string       FileExts { set { tbFileMaskFile.Text = value; m_Pref.FileMasks = value; } }
        public ProtocolView ProtView { get { return m_ProtView; } }
        ...
        ***************************************************************************/
        ...
        private const int DB_VERSION     = 360;  // 02.07.2024
        private const string RELEASE     = "Release: 1.38";
        private const string BASE_NAME   = "backup";
        private const string INI_FNAME   = BASE_NAME + ".ini";
        private const string EXP_FNAME   = BASE_NAME + "_1.ini";
        ...
        private MenuItem                mitmExprtSttngs;
        private MenuItem                mitmImprtSttngs;
        private MenuItem                menuItem7;
        private TextBox                 tbFileMaskFile;
        ...
        ***************************************************************************/
        public MainDlg()
		{
            ...
            m_ExportFname    = sCurrDir + EXP_FNAME;
            m_Backup         = null;
            m_bRunning       = false;
            m_iOldCurrFiles  = 0;
            m_iOldFProg      = 0;
            ...
            m_Pref           = new PreferencesForm( this );
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.tbFileMaskFile = new System.Windows.Forms.TextBox();
            ...
            this.mitmExprtSttngs = new System.Windows.Forms.MenuItem();
            this.mitmImprtSttngs = new System.Windows.Forms.MenuItem();
            ...
            this.StartBtn.Location = new System.Drawing.Point(637, 414);
            ...
            this.groupBox1.Controls.Add(this.tbFileMaskFile);
            ...
            // tbFileMaskFile
            // 
            this.tbFileMaskFile.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
            this.tbFileMaskFile.Location = new System.Drawing.Point(16, 195);
            this.tbFileMaskFile.Name = "tbFileMaskFile";
            this.tbFileMaskFile.ReadOnly = true;
            this.tbFileMaskFile.Size = new System.Drawing.Size(502, 20);
            this.tbFileMaskFile.TabIndex = 14;
            this.tbFileMaskFile.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
            // 
            // button_SelectInvert
            // 
            ...
            this.button_SelectInvert.Location = new System.Drawing.Point(615, 194);
            ...
            this.button_SelectAll.Location = new System.Drawing.Point(540, 194);
            ...
            this.menuItem1,
            this.mitmExprtSttngs,
            this.mitmImprtSttngs,
            this.menuItem7,
            this.menuItemPrefer,
            this.menuItem3,
            ...
            // mitmExprtSttngs
            // 
            this.mitmExprtSttngs.Index = 9;
            this.mitmExprtSttngs.Text = "E&xport settings ...";
            this.mitmExprtSttngs.Click += new System.EventHandler(this.mitmExprtSttngs_Click);
            // 
            // mitmImprtSttngs
            // 
            this.mitmImprtSttngs.Index = 10;
            this.mitmImprtSttngs.Text = "Import settings ...";
            this.mitmImprtSttngs.Click += new System.EventHandler(this.mitmImprtSttngs_Click);
            // 
            // menuItem7
            // 
            ...
            this.textBoxActivity.Location = new System.Drawing.Point(16, 385);
            ...
            this.textBoxFilename.Location = new System.Drawing.Point(16, 414);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.progressBarFile.Location = new System.Drawing.Point(16, 440);
            ...
            this.button_Swap.Location = new System.Drawing.Point(296, 245);
            ...
            this.checkShutdown.Location = new System.Drawing.Point(556, 258);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
            this.progressBarAll.Location = new System.Drawing.Point(16, 462);
            ...
            this.textBox_Timer.Location = new System.Drawing.Point(16, 248);
            ...
            this.textBoxCounts.Location = new System.Drawing.Point(84, 248);
            ...
            this.checkHibernate.Location = new System.Drawing.Point(556, 241);
            ...
            this.label1.Location = new System.Drawing.Point(629, 252);
            ...
            this.comboDest.Txt = "Enter destination folder";
            // 
            // listViewFiles
            // 
            ...
            this.listViewFiles.Size = new System.Drawing.Size(659, 113);
            ...
            this.comboSrc.Txt = "Enter source folder";
       ...
       ***************************************************************************/
        ...
        ***************************************************************************/
        ...
        LAST CHANGE:   11.11.2024
        ***************************************************************************/
        private delegate void dl_ShowReady();
        private void ShowReady()
        {
            if (this.InvokeRequired)
            {
                dl_ShowReady d = new dl_ShowReady(ShowReady);
        ...
        ***************************************************************************/
        private FavDataSet GiveCurrProps()
        {
            ...
            else
            {
                ...
                ds.sFileMsks      = m_Pref.FileMasks;
                ds.LoadSelected( m_Selected );
        ...
        ***************************************************************************/
        private void Serialize(ref AppSettings a_Conf)
        {
            ...
            if ( m_Config.IsReading )
            {
                if ( tbFileMaskFile.Text == "" ) tbFileMaskFile.Text = m_Pref.FileMasks; 
            }
        }
        ...
        private void Form_Load(object sender, System.EventArgs e)
        {
            ...
            if (m_Config.OpenRead()) 
            {
                ...
                finally
                {
                    ...
                    tbFileMaskFile.Text = m_Pref.FileMasks;
        ...
        ***************************************************************************/
        private void comboSrcDrv_SelectedIndexChanged(object sender,EventArgs e)
        {
            ...
            foreach( ListViewItem li in listViewFiles.SelectedItems ) sels.Add( li.Text.ToLower() );
            ...
            // restore selections in new file list
            foreach( ListViewItem li in listViewFiles.Items )
            {
                string f = sels.Find( i => i == li.Text.ToLower() );
                if ( f == null ) li.Selected = false;
        ...
        ***************************************************************************/
        private List<string> SaveMarked()
        {
            List<string> ret = new List<string>();
            //ret.AddRange( listViewFiles.SelectedItems );
            return ret;
        }
        ...
        ***************************************************************************/
        private void mitmExprtSttngs_Click( object sender, EventArgs e )
        {
            m_Config.MakeExportFname( ref m_ExportFname, "BU" );
        ...
        LAST CHANGE:   06.05.2021
        ***************************************************************************/
        private void mitmImprtSttngs_Click( object sender, EventArgs e )
        {
