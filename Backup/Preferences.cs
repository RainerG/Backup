...
namespace NS_Backup
{
	...
	{
        //public event dl_CloseProtView m_eCloseProtView;

        private DialogPosSize   m_ProtLoc;
        private DialogPosSize   m_MaskLoc;
        //private UserTextEditor  m_ProtView;
        ...
        ***************************************************************************/
        public void ShowProtView()
        {
            ...
            //m_ProtView = new UserTextEditor(comboFileProt.Text);
            m_ProtView = new ProtocolView(comboFileProt.Text);
            ...
            if (! m_ProtLoc.IsInit())
            {
                m_ProtView.Loc = m_ProtLoc.Loc;
                m_ProtView.Siz = m_ProtLoc.Siz; 
            }

            m_ProtView.ShowDialog();

            m_ProtLoc.Loc = m_ProtView.Location;
            m_ProtLoc.Siz = m_ProtView.Size;
        }
